...
- (instancetype)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        ...
        //添加按钮
        WYLeftMenuButton *newsBtn = [self setupButtonWithTitle:@"新闻" imageName:@"sidebar_nav_news" color:WYColorRGBA(202, 68, 73, alpha)];
        newsBtn.selected = YES; //设置默认选中
        self.currentSelectedBtn = newsBtn;
 ...
 *  添加按钮
 */
- (WYLeftMenuButton *)setupButtonWithTitle:(NSString *)title imageName:(NSString *)imageName color:(UIColor *)color
{
